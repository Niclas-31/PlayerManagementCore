package de.niclasl.playerManagementCore.multienchant.command;
...
public record EnchantCommand(PlayerManagementCore plugin) implements CommandExecutor, TabCompleter {
