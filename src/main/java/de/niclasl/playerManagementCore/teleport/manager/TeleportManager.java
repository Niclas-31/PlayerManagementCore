package de.niclasl.playerManagementCore.teleport.manager;
...
public class TeleportManager {
    ...
    public static boolean dimensionExists(String dimension) {
        return dimensionFiles.containsKey(dimension + ".yml")
                || new File(folder, dimension + ".yml").exists();
    }
    ...
    public static void createDimension(String dimension, String dimensionType, Player player) {
        if ((dimensionType.equalsIgnoreCase("nether")
                || dimensionType.equalsIgnoreCase("end"))
                && !player.hasPermission("playerManagementCore.teleport.dimension.setcoords")) {
