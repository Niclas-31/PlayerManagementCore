package de.niclasl.playerManagementCore.portal.commands;
...
public record PortalCommand(PlayerManagementCore plugin) implements CommandExecutor, TabCompleter {
