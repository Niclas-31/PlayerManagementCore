package de.niclasl.playerManagementCore.gamemode_manage.gui;
...
public class GamemodeGui {
    ...
    public static PlayerManagementCore plugin;

    public static void init(PlayerManagementCore plugin) {
