...
import de.niclasl.playerManagementCore.warn_system.manage.WarnActionConfigManager;
...
public class WarnCommand implements CommandExecutor, TabCompleter {
    ...
    public WarnCommand(WarnManager warnManager, BanHistoryManager banManager, PlayerManagementCore plugin) {
