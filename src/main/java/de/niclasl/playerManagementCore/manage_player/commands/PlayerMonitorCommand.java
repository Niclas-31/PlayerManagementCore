package de.niclasl.playerManagementCore.manage_player.commands;
...
public record PlayerMonitorCommand(PlayerManagementCore plugin) implements CommandExecutor, TabCompleter {
